...
static Model tdb;
static String owlFile = "/projects/garden-planner/input/garden.owl";
static String dataFile = "/projects/garden-planner/input/plants.rdf";
static String logFile = "logs/log4j.properties";
static InfModel infmodel;
static String directory = "/projects/garden-planner/tdb";
...
private static boolean createDirectoryIfNeeded(String directoryName)
{
...
public static Model createDBModel(String directory, InfModel model) {
	Boolean folder = createDirectoryIfNeeded(directory);
	if(folder){
...
// this method reads ontology file and RDF file from disk and creates an inference model
	private static InfModel createInfModel(String owlFile, String dataFile){
...
PropertyConfigurator.configure(root+logFile);
infmodel = createInfModel(root+owlFile, root+dataFile);
tdb = createDBModel(root+directory,infmodel);
%>
