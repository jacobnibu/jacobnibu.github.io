(function(m){var u={itemSelector:"> div",itemWidth:320,marginX:0,marginY:0,align:"left",fitWidth:!0,animate:!0,autoResize:!0,resizeDelay:50};m.fn.pinto=function(g){var e=m(this),a=m.extend(u,g);e.css("position","relative");var r=function(){if(e.is(":visible")){for(var g=a.animate?"top 0.5s, left 0.5s":"none",b=e.find(a.itemSelector),p=e.innerWidth(),l=parseInt(a.marginX||0),q=parseInt(a.marginY||0),f=a.itemWidth,c=Math.max(Math.floor(p/(f+l)),1),d=[],h=c;h--;)d.push(0);var n=0;a.fitWidth?f+=Math.floor(.5+
